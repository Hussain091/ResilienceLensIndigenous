...
const timelineEras = [
  {
    year: '1876',
    era: 'The Indian Act',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/Indian_Act_1876.jpg/800px-Indian_Act_1876.jpg',
    imageAlt: 'Original Indian Act document 1876',
    withoutResilience: {
      label: 'Without Resilience',
      outcome: 'Complete cultural erasure. Languages disappear within a generation. Ceremonies vanish. Communities have no legal standing to fight back. Indigenous identity is absorbed and forgotten.',
      color: 'from-red-900 to-rose-800',
      icon: '✕',
    },
    withResilience: {
      label: 'With Resilience',
      outcome: 'Communities secretly maintain ceremonies underground. Elders pass language to children in whispers. Networks of resistance form quietly. Identity survives beneath the surface, waiting.',
  ...
  },
  {
    ...
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Kamloops_Indian_Residential_School.jpg/1280px-Kamloops_Indian_Residential_School.jpg',
    imageAlt: 'Kamloops Indian Residential School building',
    withoutResilience: {
      label: 'Without Resilience',
      outcome: 'Children lose all connection to family, language, and culture. Generations grow up not knowing who they are. The cycle of disconnection becomes permanent. Communities dissolve.',
      color: 'from-red-900 to-rose-800',
      icon: '✕',
    },
    withResilience: {
      label: 'With Resilience',
      outcome: 'Survivors speak out. Families document what was taken. Some children teach each other their languages in secret. Survivors become the strongest advocates for the next generation.',
      color: 'from-amber-800 to-orange-700',
      icon: '↑',
    },
  ...
  },
  {
    ...
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/2010_Olympics_-_Aboriginal_Pavilion_dancers.jpg/1280px-2010_Olympics_-_Aboriginal_Pavilion_dancers.jpg',
    imageAlt: 'Indigenous dancers at the 2010 Olympics Aboriginal Pavilion',
    withoutResilience: {
      label: 'Without Resilience',
      outcome: 'An entire generation grows up without cultural roots. The knowledge of elders has no one to receive it. Languages reach their final speakers with no successors. Communities shrink and scatter.',
      color: 'from-red-900 to-rose-800',
      icon: '✕',
    },
    withResilience: {
      label: 'With Resilience',
      outcome: 'Adoptees later search for and reconnect with their Nations. Communities create records and archives to preserve what was stolen. Legal battles begin. The stolen generation starts coming home.',
      color: 'from-amber-800 to-orange-700',
      icon: '↑',
    },
  ...
  },
  {
    ...
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Idle_No_More_-_Parliament_Hill_-_December_21%2C_2012_%288293895346%29.jpg/1280px-Idle_No_More_-_Parliament_Hill_-_December_21%2C_2012_%288293895346%29.jpg',
    imageAlt: 'Indigenous protest on Parliament Hill',
    withoutResilience: {
      label: 'Without Resilience',
      outcome: 'No political representation. Policies continue without consultation. Land rights are ignored. No organized voice exists to challenge the systems in place. The status quo holds.',
      color: 'from-red-900 to-rose-800',
      icon: '✕',
    },
    withResilience: {
      label: 'With Resilience',
      outcome: 'The Assembly of First Nations grows in power. Legal challenges begin winning in court. The Royal Commission on Aboriginal Peoples releases a landmark 4,000 page report. Voices get louder.',
      color: 'from-amber-800 to-orange-700',
      icon: '↑',
    },
    fact: 'The 1996 Royal Commission on Aboriginal Peoples was one of the most comprehensive reports on Indigenous rights in Canadian history.',
  },
  {
    year: '2012',
    era: 'Idle No More',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1c/Round_dance_flash_mob_Idle_No_More_West_Edmonton_Mall.jpg/1280px-Round_dance_flash_mob_Idle_No_More_West_Edmonton_Mall.jpg',
    imageAlt: 'Idle No More round dance flash mob at West Edmonton Mall',
    withoutResilience: {
      label: 'Without Resilience',
      outcome: 'Bills passing without consultation go unchallenged. Environmental protections on Indigenous land are stripped. The changes pass quietly. Communities have no platform to respond.',
      color: 'from-red-900 to-rose-800',
      icon: '✕',
    },
    withResilience: {
      label: 'With Resilience',
      outcome: 'Four women in Saskatchewan spark a global movement. Round dances shut down malls. Parliament Hill is flooded with protesters. Idle No More spreads to 30+ countries. The world is watching.',
      color: 'from-amber-800 to-orange-700',
      icon: '↑',
    },
  ...
  {
    year: '2015',
    era: 'Truth & Reconciliation',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Truth_and_Reconciliation_Commission_of_Canada%2C_Toronto%2C_June_2012.jpg/1280px-Truth_and_Reconciliation_Commission_of_Canada%2C_Toronto%2C_June_2012.jpg',
    imageAlt: 'Truth and Reconciliation Commission event Toronto 2012',
    withoutResilience: {
      label: 'Without Resilience',
      outcome: 'The stories of residential school survivors are never formally heard. No national acknowledgement happens. Canada moves on. The history stays buried. 94 Calls to Action are never written.',
      color: 'from-red-900 to-rose-800',
      icon: '✕',
    },
    withResilience: {
      label: 'With Resilience',
      outcome: 'Survivors testify. The Truth and Reconciliation Commission produces 94 Calls to Action. Canada is forced to confront its history publicly. Orange Shirt Day becomes a national day of remembrance.',
      color: 'from-amber-800 to-orange-700',
      icon: '↑',
    },
    fact: 'The TRC produced 94 Calls to Action after hearing testimony from thousands of residential school survivors. As of 2025, only 13 have been fully completed.',
  },
  {
    year: '2021',
    era: 'Kamloops Discovery',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Powwow_in_Blackfoot_Crossing.jpg/1280px-Powwow_in_Blackfoot_Crossing.jpg',
    imageAlt: 'Powwow at Blackfoot Crossing as symbol of cultural resilience',
    withoutResilience: {
      label: 'Without Resilience',
      outcome: 'The remains of children stay undiscovered. No national conversation happens. The school sites sit unmarked. The families never get answers. The history is never acknowledged.',
      color: 'from-red-900 to-rose-800',
      icon: '✕',
    },
    withResilience: {
      label: 'With Resilience',
      outcome: "The Tk'emlups te Secwepemc Nation uses ground-penetrating radar. 215 children are found. The country is shaken. Flags are lowered. Hundreds of orange shirts appear on Parliament Hill.",
      color: 'from-amber-800 to-orange-700',
      icon: '↑',
    },
    fact: 'In May 2021, the remains of 215 children were discovered at the site of the Kamloops Indian Residential School, reigniting national conversation about colonial violence.',
  },
  {
    year: '2025',
    era: 'Today',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Mikmaq_crafts.jpg/1280px-Mikmaq_crafts.jpg',
    imageAlt: "Mi'kmaq traditional crafts representing cultural continuity",
    withoutResilience: {
      label: 'Without Resilience',
      outcome: 'Languages extinct. Cultures erased. Communities dissolved. No political representation. No legal victories. No TRC. No Idle No More. Nothing left to pass down. The plan would have worked.',
      color: 'from-red-900 to-rose-800',
      icon: '✕',
    },
    withResilience: {
      label: 'With Resilience',
      outcome: 'Record 12 Indigenous MPs elected. Mikmaw Language Act passed. Haisla Nation owns Cedar LNG. Languages being revived from recordings. Communities healing on their own terms. Still here. Still fighting.',
      color: 'from-amber-800 to-orange-700',
      icon: '↑',
    },
